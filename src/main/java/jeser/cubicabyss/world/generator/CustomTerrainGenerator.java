...
import jeser.cubicabyss.world.generator.GeneratorsLayers.CoreGenerationLayer;
import jeser.cubicabyss.world.generator.GeneratorsLayers.IGenerationLayer;
...
public class CustomTerrainGenerator extends BasicCubeGenerator {
    ...
    IGenerationLayer[] GenerationLayers = new IGenerationLayer[]{
            new CoreGenerationLayer(world.getSeed())
    };
                    ...
                    if (globalY > 64) {
                        ...
                        if (distance < AbyssWorldGenerator.RADIUS) {
                            ...
                            for (IGenerationLayer layer : GenerationLayers)
                                state = layer.getBlock(x, y, z, distance, state);
