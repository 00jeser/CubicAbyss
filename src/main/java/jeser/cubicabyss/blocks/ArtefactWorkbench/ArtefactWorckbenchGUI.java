...
public class ArtefactWorckbenchGUI extends GuiContainer {
    private static final ResourceLocation METAL_WORKBENCH_GUI_TEXTURE = new ResourceLocation(CubicAbyss.MOD_ID + ":textures/gui/container/artefact_worckbench.png");
